                            ...
                            @forelse ($employees as $employee)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <form id="approve-form" action="{{ route('admin.employees.approve', $employee) }}" method="POST" style="display: none;">
                                            {{ csrf_field() }}
                                        </form>
                                    </td>
                                    <td class="text-center">
                                        ...
                                        <form id="reject-form" action="{{ route('admin.employees.reject', $employee) }}" method="POST" style="display: none;">
                                            {{ csrf_field() }}
                                        </form>
                                    </td>
                                </tr>
